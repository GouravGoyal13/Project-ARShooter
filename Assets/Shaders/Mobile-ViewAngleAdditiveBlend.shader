Shader "GLU/View Angle Additive Blend" 
{
	Properties 
	{
	...
	SubShader 
	{
		...
		Pass
		{
			...
			PixelOut p ( VertOut input )
			{
				...
				float3 rgbColor = (textureColor.rgb  * input.alpha.x) * input.vertColor.xyz;
				float4 finalColor = float4( rgbColor,  textureColor.a );
